...
public class FuncionarioService {
    ...
    public FuncionarioService(FuncionarioJpaRepository funcionarioJpaRepository, PasswordEncoder passwordEncoder, GerenciadorTokenJwt gerenciadorTokenJwt, AuthenticationManager authenticationManager) {
    ...
    public void criar(Funcionario funcionario) {
        ...
        this.funcionarioJpaRepository.save(funcionario);
    }
    ...
    public FuncionarioTokenDto autenticar(Funcionario funcionario) {
        ...
        Funcionario funcionarioAutenticado = funcionarioJpaRepository.findByEmail(funcionario.getEmail()).orElseThrow(() -> new ResponseStatusException(404, "Emial do usuário não cadastrado", null));
    ...
    public List<FuncionarioListDto> listarTodos() {
        List<Funcionario> funcionariosEncontrados = funcionarioJpaRepository.findAll();
    ...
    public Funcionario atualizar(Funcionario funcionario) {
        if (funcionarioJpaRepository.existsById(funcionario.getId())) {
