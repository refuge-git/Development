...
public class RegistroAtendimentoResponseDto {
    ...
    public RegistroAtendimentoResponseDto(Integer id, LocalDateTime dataHora, Integer tipoAtendimento, Integer beneficiario) {
        this.id = id;
    ...
    public RegistroAtendimentoResponseDto() {
    }
